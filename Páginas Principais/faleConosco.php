...
<section class="fale-conosco">
    ...
    <div class="container fale-content">

        <!-- LADO ESQUERDO -->

        <div class="fale-esquerda">
            <img src="../Projeto-Clinica-Lima-Estevam/imagens/duvidas.png" alt="duvidas">
        </div>


        <!-- LADO DIREITO -->

        <div class="fale-direita">

            <h2>Dúvidas frequentes</h2>

            <ul class="duvidas">

                <li>Como saber os detalhes do agendamento?</li>

                <li>Quero fazer agendamento</li>

                <li>Quero fazer elogios ou reclamações</li>

                <li>Quero cancelar a minha consulta como faço?</li>
